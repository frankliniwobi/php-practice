        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/posts"
                            class="<?= urlIs('/posts') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Posts</a>
                        <a href="/contact"
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <?php else : ?>
                    <a href="/login"
                        class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white mr-1 px-3 py-2 rounded-md text-sm font-medium">
                        Login
                    </a>
                    <a href="/register"
